...
temporal test of live answerability. The designs don't jointly identify the profile against
an unrestricted effective-coverage description. Their purpose is to test whether a
...
The profile predicts an advantage for the checker with lower conditional error overlap.
Calibration history matters only insofar as it predicts that overlap; if admissible
perturbations produce no difference, the profile has no reason to privilege one history.
